<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="CollectSpecialOrder.aspx.cs" Inherits="CollectSpecialOrder" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    <asp:GridView ID="gvData" runat="server" AutoGenerateColumns="False" EmptyDataText="No data to display"
        ...
        <Columns>
            ...
            <asp:ButtonField HeaderText="" Text="Collect" CommandName="col" ItemStyle-HorizontalAlign="Center">
