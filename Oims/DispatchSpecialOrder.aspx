<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="DispatchSpecialOrder.aspx.cs" Inherits="DispatchSpecialOrder" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    <asp:GridView ID="gvData" runat="server" AutoGenerateColumns="False" EmptyDataText="No data to display"
        ...
        <Columns>
            ...
            <asp:ButtonField HeaderText="" Text="Dispatch" CommandName="disp" ItemStyle-HorizontalAlign="Center">
