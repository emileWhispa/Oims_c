<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="StockCard.aspx.cs" Inherits="StockCard" %>
        ...
        <tr>
         ...
         <asp:GridView ID="gvData" runat="server" AutoGenerateColumns="False" EmptyDataText="No data to display"
            ...
            <Columns>
                ...
                <asp:Bou    ndField DataField="OpeningQuantity" HeaderText="Opening Qty" />
