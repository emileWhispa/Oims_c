<%@ Page Title="Oims|Specialorders" Language="C#" MasterPageFile="~/Site.Master"
    AutoEventWireup="true" CodeFile="Specialorders.aspx.cs" Inherits="orion.ims.Specialorders" %>
        ...
        <fieldset>
            <asp:GridView ID="gvData" runat="server" AutoGenerateColumns="False" EmptyDataText="No data to display"
                ...
                <Columns>
                    ...
                    <asp:ButtonField HeaderText="" Text="Edit" CommandName="    " ItemStyle-HorizontalAlign="Center">
