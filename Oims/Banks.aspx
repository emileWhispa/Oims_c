<%@ Page Title="Orion|Banks" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeFile="Banks.aspx.cs" Inherits="orion.ims.Banks" %>
        ...
        <table>
            ...
            <tr>
                ...
                <td>
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="*" CssClass="validation-error" ControlToValidate="txtBankName" />
                </td>
            </tr>
            <tr>
                <td class="auto-style1">
